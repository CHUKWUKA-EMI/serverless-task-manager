...
To implement this project, you need to implement a simple TASK application using AWS Lambda and Serverless framework. Search for all comments starting with the `TASK:` in the code to find the placeholders that you need to implement.
...
To store TASK items, you might want to use a DynamoDB table with local secondary index(es). A create a local secondary index you need to create a DynamoDB resource like this:
